...
public class ClassGen {
   ...
   */
  public void gen(Inform8Table table, HashMap<String, Object> extras) throws Exception {
    ...
    if (tableTemplates.length > 0) {
      for (String templateName : tableTemplates) {
        String daMerge = merge(table, templateName, extras);
    ...
    for (String file : folders) {
      ...
      if (tableTemplates.length > 0) {
        ...
        for (String templateName : tableTemplates) {
          ...
          String daMerge = merge(table, file + File.separator + templateName, extras);
   ...
   * @throws Exception
   */
  private String merge(Inform8Table t, String template, HashMap<String, Object> extras) throws Exception {
