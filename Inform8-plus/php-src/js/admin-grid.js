...
function loadGrid(gridId, quickEditId, toolbarId, quickSearchFormId, xhr, tableDef)  {
	...
	for(var i=0;i < ids.length;i++){ 
		...
		fullEdit = " <a href='#' title='View/Edit in a new tab' onclick=\"newTab('ajax.php?pkg=update&call=" + tableDef.name + "Update&id="+cl+"', '" + getLanguageEntry('Tbl_' + tableDef.name) + " " + cl + "'); return false;\" ><img src='images/smtb/advedit.jpg' /></a>";				
